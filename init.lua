...
--vim.builtin.which_key.mappings['t'] = { '<cmd>ToggleTerm direction=vertical size=50<CR>', 'Terminal' }
...
-- Automatically save and restore your colorscheme preference
local colorscheme_file = vim.fn.stdpath 'cache' .. '/current_colorscheme.txt'
local default_colorscheme = 'catpuccin-mocha'
...
-- Load colorscheme after a short delay to ensure plugins are loaded
